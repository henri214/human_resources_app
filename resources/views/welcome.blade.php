...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Login at the
                            <a href="{{ asset(route('login')) }}" target="_blank"
                    ...
                    <li
                        ...
                        <span>
                            ...
                            <a href="{{ asset(route('register')) }}" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ms-1">
                                <span>Here!</span>
                                <svg width="10" height="11" viewBox="0 0 10 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="w-2.5 h-2.5">
            ...
            <div
                class="bg-[#f2f6ff90] dark:bg-[#00001d] relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                <img src="{{ asset('images/erca_logo.png') }}"
                    class="w-full border-accent-content text-[#0364f5] dark:text-[#0031f6] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
                    viewBox="0 0 438 104" fill="none">
                </img>
